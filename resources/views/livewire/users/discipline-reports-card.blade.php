                        ...
                        @else
                            <div class="space-y-2">
                                @foreach($this->reportTopics as $topic)
                                    <a href="{{ route('topics.show', $topic) }}" class="flex items-center justify-between rounded border border-zinc-200 dark:border-zinc-700 p-2 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition">
                                        <div>
