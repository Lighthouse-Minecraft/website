...
new class extends Component {
    ...
    public function createBoardMember(): void
    {
        ...
        $photoPath = null;
        if ($this->newPhoto) {
            $photoPath = $this->newPhoto->store('board-member-photos', config('filesystems.public'));
        }
    ...
    public function updateBoardMember(): void
    {
        ...
        $oldPhotoPath = null;
        if ($this->editPhoto) {
            $newPath = $this->editPhoto->store('board-member-photos', config('filesystems.public'));
            if ($newPath) {
        ...
        if ($oldPhotoPath) {
            Storage::disk(config('filesystems.public'))->delete($oldPhotoPath);
        }
