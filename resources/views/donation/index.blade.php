    ...
    <div class="flex w-full">
        ...
        @if(config('lighthouse.stripe.one_time_donation_url'))
            <flux:card class="overflow-hidden min-w-[16rem] my-6 w-full md:w-1/4 mx-2">
                ...
                <flux:heading size="xl" class="mt-2 tabular-nums flex">
                    <flux:button href="{{  config('lighthouse.stripe.one_time_donation_url') }}" variant="primary" color="sky">Make a One-Time Donation</flux:button>
                </flux:heading>
            </flux:card>
        @endif
    </div>
