...
These policies describe how Lighthouse is operated as a community — how decisions are made, how policies are created and updated, how the community handles financial matters at a policy level, and how Lighthouse communicates with its members about significant changes.

## Leadership Structure and Decision-Making

Lighthouse is led by the Command department, which holds overall responsibility for the community's direction, health, and operations. Command includes the lead administrator and senior leadership staff.
...
Community policies — including those in this manual — are created and maintained by Command. The process:

1. **Identification.** A need for a new policy or a change to an existing one is identified — either by staff or through member feedback.
2. **Drafting.** A draft is written, typically by Command or a delegated staff member.
3. **Review.** The draft is reviewed internally before being adopted.
...
Lighthouse accepts voluntary donations from members to cover server hosting and operational costs. At a policy level:

- Donations are voluntary. No member is required to donate to be a full participant in the community.
...
Lighthouse grows through relationship and reputation. Our approach to outreach:

- We do not engage in aggressive or deceptive recruitment practices.
- We welcome members who find us organically or are invited by existing members.
- We represent the community honestly in all external communications.
- Growth is pursued as a means of building a thriving community, not as an end in itself.
...
For questions about community operations or these policies, submit a [Support Ticket](/tickets/create).
