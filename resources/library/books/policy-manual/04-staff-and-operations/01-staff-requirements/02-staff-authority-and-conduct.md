...
## Purpose of Staff Authority

Staff authority is given for three primary purposes:

- **Protection** — keeping the community safe and enforcing rules.
- **Support** — assisting players with issues, questions, and technical problems.
- **Stability** — maintaining a fair, consistent, and playable environment.
...
- Modifying players (size, abilities, status effects, etc.) without a valid administrative reason and the player’s consent.
- Creating or distributing overpowered or non-survival items.
- Using commands or tools “for fun” in a way that impacts other players.
- Interfering with gameplay without a clear and necessary reason.
- Applying effects that persist beyond the current session or require cleanup later.

Staff are expected to leave the environment as they found it — stable, fair, and playable for all members.

---

## Creative Mode & World Integrity
...
- Barrier blocks  
- Bedrock or void-based decorative blocks  
- Creative-only items or effects  
- Any structure or element that cannot reasonably be created in survival  
...
- Intentional  
- Limited in scope  
- Clearly separated from normal player gameplay  
- Transparent to the community where appropriate  
...
- Do not use staff abilities to “mess with” or entertain at the expense of players.
- Do not target players with actions or effects without a valid reason.
- Do not show favoritism or grant advantages to specific players.
- Do not insert yourself into gameplay in a way that disrupts or overrides player effort.

All interactions should reinforce trust, fairness, and consistency within the community.

---

## Events and Approved Exceptions
...
- Effects must be temporary and fully reversible.
- No lasting impact should remain on players or the world.
- Events should be planned, communicated, and (when appropriate) approved in advance.
...
- Loss of specific permissions  
- Removal from staff  
- Additional disciplinary action depending on severity  
