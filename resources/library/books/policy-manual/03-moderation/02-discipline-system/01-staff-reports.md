...
- Any category label assigned by staff
...
## Where Incidents Are Tracked

Reports record where an incident occurred:

- **Minecraft** — in-game activity on the Lighthouse server
- **Discord Text** — behavior in Discord text channels
- **Discord Voice** — behavior in Discord voice channels
- **Other** — any other context (website, external platforms, etc.)
