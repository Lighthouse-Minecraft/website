---
title: 'Departments & Ranks'
visibility: staff
order: 2
summary: 'How the staff team is organized into departments and ranks.'
---

## Overview

The Lighthouse staff team is organized into **departments** (what you work on) and **ranks** (your level of responsibility). Every staff member is assigned to one department and holds one rank.

## Departments

There are five departments. Each one covers a different area of community operations.
...
Each staff member holds a specific **position** within their department -- for example, "Head Engineer" or "Steward." Your position determines your rank and department assignment.

A staff member can only hold one position at a time. If you're reassigned to a different position, your old one is automatically vacated and your rank and department update to match the new role.

## Department Access in the Ready Room

In the Ready Room, you'll see tabs based on your access level:

- **My Board** -- everyone sees this (your personal tasks and meetings)
- **Your department tab** -- you can always see your own department's tab
- **All department tabs** -- Officers can see every department's tab, not just their own
