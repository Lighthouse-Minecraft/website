...
$expectedRoles = [
    ...
    ['name' => 'Attend Staff Meeting', 'description' => 'Read-only access to staff meetings', 'color' => 'sky', 'icon' => 'eye'],
    ['name' => 'Manage Staff Meeting', 'description' => 'Write access to staff meetings', 'color' => 'blue', 'icon' => 'pencil-square'],
    ['name' => 'Edit Docs', 'description' => 'Edit documentation and handbook pages', 'color' => 'violet', 'icon' => 'document-text'],
